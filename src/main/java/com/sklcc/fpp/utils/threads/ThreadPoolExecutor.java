...
public class ThreadPoolExecutor extends java.util.concurrent.ThreadPoolExecutor {
    private static final Logger log                        = LogManager.getLogger(ThreadPoolExecutor.class);
        ...
        if (currentThreadShouldBeStopped()) {
            ...
            if (lastTime + threadRenewalDelay < System.currentTimeMillis()) {
                if (lastTimeThreadKilledItself.compareAndSet(lastTime,
                    ...
                    final String msg = new String("threadPoolExecutor.threadStoppedToAvoidPotentialLeak" +
    ...
    protected boolean currentThreadShouldBeStopped() {
        if (threadRenewalDelay >= 0
            ...
            if (currentTaskThread.getCreationTime() < this.lastContextStoppedTime.longValue()) { return true; }
        }
        return false;
    }
